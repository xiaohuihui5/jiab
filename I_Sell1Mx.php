...
<td algin=center><div class="text-c"><input type="text" class="input-text" style="width:300px"  id="bz1" name="bz1" onkeydown="if(event.keyCode==13){window.IFrm.dinghl.focus();}else  if(event.keyCode==37){window.IFrm.spdm.select();}"></div></td>
<td algin=center><div class="text-c"><input type="text" class="input-text" style="width:80px" id="dinghl" name="dinghl" onkeypress="check(this,2)" onkeydown="if(event.keyCode==13){window.IFrm.fudw.select();}else  if(event.keyCode==39){window.IFrm.fudw.select();}else  if(event.keyCode==37){window.IFrm.spdm.select();}"></div></td>
<td algin=center><div class="text-c"><input type="text" class="input-text" style="width:60px" id="fudw" name="fudw" onkeydown="if(event.keyCode==13){window.IFrm.dj.focus();}else  if(event.keyCode==39){window.IFrm.dj.select();}else if(event.keyCode==37){window.IFrm.dinghl.select();}"></div></td>
<td algin=center><div class="text-c"><input type="text" class="input-text" style="width:80px" id="dj" name="dj" onkeydown="if(event.keyCode==13){window.IFrm.bz.select();}else  if(event.keyCode==39){window.IFrm.bz.select();}else  if(event.keyCode==37){window.IFrm.fudw.select();}" onkeypress="check(this,2)"></div></td>
...
$lie=",序,排,编号,商品名称,单位,客户品名,订货单位,订货量,配送量,实收量,单价,金额,备注,删";
$wid=",2%,2%,5%,17%,3%,18%,5%,7%,7%,5%,5%,6%,14%,4%";
}
else
{
$lie=",序,排,编号,商品名称,规格,订货数,订货量,订货单位,配送数,配送量,实收数,实收量,单位,单价,金额,客户备注,备注";
...
function sub()
{
	...
	else if($("input[name=dinghl]").val()=="" || $("input[name=dinghl]").val()==null)
	{
		layer.msg('请填订货量！', {icon:2,time:1500});

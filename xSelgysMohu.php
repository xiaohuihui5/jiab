...
$query = "select top 10 usercode,shortname,id from sys_unit where mode=1 and yn=1 and usercode+shortname+isnull(name,'')+isnull(piny,'') like '%".$str."%' order by usercode";

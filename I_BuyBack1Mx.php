...
$lie=",序,编号,商品名称,规格,退货量,单位,单价,金额,备注,删";
$wid=",5%,10%,20%,10%,10%,5%,10%,10%,15%,5%";
}
else
{
$lie=",序,编号,商品名称,规格,退货量,单位,单价,金额,备注";
$wid=",5%,10%,20%,10%,10%,10%,10%,10%,15%";
}
$xuh='';
$yul='';
...
clip1.setText('<?php echo $_REQUEST['dhid'];?>;p04.fr3;0;1;1;=)(=');
clip1.glue('c1');
</script>
<script language ="javascript">
function sub()

...
//获取今日入库生猪供应商
$szgys="0";
$query="select sj.ck from sys_jhsj sj,sys_jhdh dh where dh.lx=5 and dh.id=sj.dhid and dh.dhrq='".$rq."'";
...
<td algin=center><div class="text-c">出库重量</div></td>
...
<a class="btn radius" href="javascript:{openwindow2(\'I_Scmaoz1MxPrint.php?dhid='.$dhid.'\',700,500);}"><img border="0" src="im/dy.png">打印出库单</a>
</span>';

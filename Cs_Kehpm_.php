...
$lnk.='<span class="r">';
if($menuright>1)//录入
$lnk.='<a onclick="layer_show2(\'添加客户分类品名\',\''.$xiam.'Add.php\',\'800\',\'800\')" class="btn radius"><img border=0 src=im/add.png> 添客户分类品名</a> <a onclick="layer_show(\'复制客户品名\',\''.$xiam.'Copy.php\',\'600\',\'500\')" class="btn radius"> 复制品名</a> ';
...
if($menuright>1)//录入权限
{
	$lie=',序,客户名称,客户编号,客户品名,客户条码,换算值,单位,规格,公司编号,公司产品,单位,规格,修改,删';
	$wid=',5%,8%,8%,10%,10%,6%,6%,8%,8%,9%,6%,8%,4%,4%';
}
else//查询权限
{
	$lie=',序,客户名称,客户编号,客户品名,客户条码,换算值,单位,规格,公司编号,公司产品,单位,规格,客户条码';
	$wid=',5%,9%,9%,10%,8%,4%,10%,8%,10%,12%,8%,8%';
}
$xuh=',,3,4,5,6';

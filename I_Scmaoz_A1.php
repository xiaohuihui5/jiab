...
$TJ=" and dh.lx=6 and dh.dhrq between '".$_SESSION['DT1']."' and '".$_SESSION['DT2']."' ";
if(isset($_POST['cxtj']) and $_POST['cxtj']!="")
	$TJ.=" and dh.dh like '%".$_POST['cxtj']."%' ";
if(isset($_POST['setsh']) and $_POST['setsh']!=100)//批量审核,由财务部审核
{
	$query="update sys_jhdh set zt=".$_POST['setsh'].",shr='".$_SESSION['uname']."' where id in(select dh.id from sys_jhdh dh where dh.lx=6 ".$TJ.")";
	require("inc/xexec.php");
}

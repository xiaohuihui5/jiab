...
mOffsetParent = mOffsetParent.offsetParent;
		...
		div.style.left=document.getElementById("spdm").offsetLeft+180+"px";
//		div.style.top=document.getElementById("spdm").offsetTop+102+"px";
	...
	function AutoFinish()
	{
	 ...
	 function AutoFinishRequest()
	 {
		...
		xmlHttp.send("inputkey="+document.getElementById("spdm").value+"&khflid="+document.getElementById("khflid").value+"&khid="+document.getElementById("khid").value+"&RQ="+document.getElementById("rq").value);
	}

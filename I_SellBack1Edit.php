...
if(isset($_POST['dt1']))
{
	...
	if($_POST['dt2']==$_POST['odt2'])//修改日期的时候单号也要跟着改,否则单号会出现混乱sys_dh表ges=2的不用修改单号
		$query="update sys_jhdh set dhrq='".$_POST['dt1']."',unit=".$_POST['khid'].",bz=".$IBZ." where id=".$_POST['dhid']."";
	else
		$query="update sys_jhdh set dh='".getdh($_POST['dt1'],$syslx)."',dhrq='".$_POST['dt1']."',unit=".$_POST['khid'].",bz=".$IBZ." where id=".$_POST['dhid']."";
...
<table>
<tr><td align=center height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c-red">*</span>&nbsp;&nbsp;&nbsp;退货日期：<input type="hidden" value="<?php echo $RQ;?>"  name="odt1"><input type="text" class="input-text" name="dt1" id="dt1" value="<?php echo $RQ;?>" onclick="calendar(this)" style="width:210px;"></td>

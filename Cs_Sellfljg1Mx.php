...
//取得单号信息
$query="select a.dh,CONVERT(varchar(10),a.brq,120),CONVERT(varchar(10),a.erq,120),b.fenlmc,a.beiz,a.unitid from sys_selljg a,sys_khfenl b where a.unitid=b.id and a.id=".$_REQUEST['dhid'];
...
$tis.="&nbsp;&nbsp;客户分类名称:<font color=black>".$line[3]."</font>";
...
$cha='';
$lnk='
<form action="'.$xiam.'1.php?dhid='.$_REQUEST['dhid'].'" target="hqlist" method="post" name="Frm">
<span class="l">
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

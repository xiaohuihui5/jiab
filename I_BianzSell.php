...
$tit='毛猪业务 <span class="c-gray en">&gt;</span> 边猪销售';
...
$lnk='<span class="l"><a href="'.$xiam.'.php"  class="btn radius"><img border=0 src=im/zhuy.png> 边猪销售</a></span>';
$lnk.='<span class="r">';
if($menuright>2)//录入
...
$cha='';
$lie=',分点,日期,客户,单号,猪种,头数,重量,单价,销售金额,费用,实收金额,备注,制单,状态,改,删';
$wid=',6%,7%,8%,7%,6%,8%,8%,8%,8%,6%,8%,8%,4%,4%,2%,2%';
$tis='点击列名可按对应列排序!';
...
function Add()
{
	layer_show2('新增边猪销售单','<?php echo $xiam;?>Add.php','450','720'); //最后一个参数是给一个标识符 
} 
</script>

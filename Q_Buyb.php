...
<?php
$tit='查询统计 <span class="c-gray en">&gt;</span> 采购查询 <span class="c-gray en">&gt;</span> 按商品汇总';
...
<a href="Q_Buyb.php"  class="btn radius"><img border=0 src=im/zhuy.png> 按商品汇总</a> 
...
$cha='';
$lie=',商品名称,单位,规格,订货量,到货量,实收量,差量,均价,实收金额,产品类别';
$wid=',18%,4%,17%,8%,8%,8%,8%,8%,9%,10%';

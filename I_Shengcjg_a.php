...
$tit='毛猪业务 <span class="c-gray en">&gt;</span> 边猪精加工';
...
$lnk='<span class="l"><a href="I_Shengcjg.php"  class="btn radius"> 生产加工</a>
 <a href="'.$xiam.'.php"  class="btn radius"><img border=0 src=im/zhuy.png> 边猪精加工</a>
 <a href="I_Shengcjg_b.php"  class="btn radius"> 分割精加工</a>
</span>';
$lnk.='<span class="r">';
if($menuright>1)//录入
...
$cha='';
$lie=',日期,时间,供应商,品种,边猪数,边猪重,加工边猪数,加工边猪重,猪头,猪脚,板油,碎油,总损耗,头损,备注,状态,改';
$wid=',8%,4%,10%,5%,5%,6%,8%,8%,6%,6%,6%,6%,6%,6%,5%,3%,2%';
$tis='';

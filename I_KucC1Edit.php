...
<tr><td align=center height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c-red">*</span>送货日期：<input type="text" class="input-text Wdate" name="dt1" onFocus="WdatePicker({lang:'zh-cn'})" id="datemin" value="<?php echo $RQ;?>" style="width:210px;"></td>

...
{
	$query="update sys_dytait set yn=yn^1 where id=".$_POST['delrow'];
	require('./inc/xexec.php');
}
if(isset($_POST['fenlmc']) || $_POST['fenlmc']!="")
{
	$query="insert into sys_dytait(bianh,fenlmc,yn) values('".$_POST['bianh']."','".$_POST['fenlmc']."',1)";
	require("./inc/xexec.php");	
}
$ed_row=0;
if(isset($_POST['edtrow']) and $_POST['edtrow']!=0)
{
	...
	{
	$query="update sys_dytait set bianh='".$_POST['bianh_']."',fenlmc='".$_POST['fenlmc_']."' where id=".$_POST['edtrow'];
	require("./inc/xexec.php");
	$ed_row=0;
	}
...
$query="select 0,dfl.id,dfl.bianh,dfl.fenlmc,case dfl.yn when 1 then '启用' else '<font color=gray>停用' end from sys_dytait dfl where dfl.id>0 ".$TJ." order by dfl.bianh";

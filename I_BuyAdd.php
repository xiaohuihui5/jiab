...
if(isset($_POST['dt1']))
{
	...
	$query="insert into sys_jhdh(dh,rq,dhrq,unit,lury,bz,zf,lx,zt) values('".getdh($_POST['dt2'],$syslx)."','".$_POST['dt1']."','".$_POST['dt2']."',".$_POST['gysid'].",'".$_SESSION['uname']."',".$IBZ.",1,$syslx,0)";
...
<tr><td align=center height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c-red">*</span>到货日期：<input type="text" class="input-text" name="dt2" id="dt2" value="<?php echo date('Y-m-d');?>" onclick="calendar(this)" style="width:210px;"></td>

...
<?php
$tit='查询统计 <span class="c-gray en">&gt;</span> 订单查询 <span class="c-gray en">&gt;</span> 客户明细';
...
<a href="Q_Sellk.php"  class="btn radius"><img border=0 src=im/zhuy.png> 客户明细</a> 
...
$cha='';
$lie=',客户编号,客户名称,备注,日期,单号,订货量,送货量,实收量,差量,实收金额';
$wid=',8%,14%,10%,8%,10%,10%,10%,10%,10%,10%';

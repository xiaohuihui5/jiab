...
<?php
$tit='查询统计 <span class="c-gray en">&gt;</span> 订单查询 <span class="c-gray en">&gt;</span> 按日汇总';
...
<a href="Q_Selld.php"  class="btn radius"><img border=0 src=im/zhuy.png> 按日汇总</a> </span>';
...
$cha='';
$lie=',日期,客户名称,订货量,送货量,实收量,差量,实收金额';
$wid=',10%,40%,10%,10%,10%,10%,10%';
$xuh=',2,3,4,5,6,7';

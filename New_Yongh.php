...
if($menuright>1)//区分权限
{
$lie=',序,所在部门,用户姓名,登录账号,登录数,职务,联系电话,手机登录,禁用,修改';
$wid=',9%,10%,10%,11%,13%,13%,13%,13%,4%,4%';
}
else
{
$lie=',序,所在部门,用户姓名,登录账号,登录数,职务,联系电话,手机登录,禁用';
$wid=',3%,10%,10%,21%,13%,13%,13%,13%,4%';
}

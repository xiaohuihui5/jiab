...
$tit='库存管理 <span class="c-gray en">&gt;</span> 出库录入';
...
$lnk='<span class="l"><a href="'.$xiam.'.php"  class="btn radius"><img border=0 src=im/zhuy.png> 出库管理</a> </span>';
$lnk.='<span class="r">';
$lnk.='<a onclick="Add()" class="btn radius"><img border=0 src=im/add.png> 新增出库单[F9]</a> </span>'; 
$cha='';
$lie=',序,单号,出库日期,出库总量(斤),总金额,制单人,修改,删除';
$wid=',10%,15%,25%,15%,15%,10%,5%,5%';

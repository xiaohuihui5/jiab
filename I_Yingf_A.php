...
$tit='财务管理 <span class="c-gray en">&gt;</span> 已付账款';
...
$lnk='<span class="l"><a href="I_Yingf.php"  class="btn radius"> 应付账款</a></a> 
<a href="'.$xiam.'.php"  class="btn radius"><img border=0 src=im/zhuy.png> 已付账款</a></a></span>';
$lnk.='<span class="r">';
if($menuright>1)//录入
$lnk.='<a onclick="exc()" class="btn radius"><img border=0 src=im/daoc.png> 导出付款单</a></span>'; 
$cha='';
$lie=',序,付款日期,制单日期,供应商名称,备注,应付款,实付款,明细,状态,制单人,作废,操作员';
$wid=',3%,10%,10%,15%,11%,15%,15%,4%,4%,5%,3%,5%';
$xuh=',,3,4,5,,7,8';

...
$zl=0;
$je=0;
//$query = "select sj.id,cp.bh,cp.mc,cp.dw,cp.gg,sj.songhl,sj.bz,dh.zt,sj.dj,sj.shisje,ck.fenlmc as ckname,sj.ck from sys_jhdh dh,sys_jhsj sj,sys_cp cp,sys_cangk as ck where dh.id=sj.dhid and sj.mc=cp.id and sj.dhid=".$_REQUEST['dhid']." and ck.id=sj.ck order by sj.id";
$query = "
SELECT sj.id,cp.bh,cp.mc,cp.dw,cp.gg,sj.songhl,sj.bz,dh.zt,sj.dj,sj.shisje,ck.fenlmc,sj.ck from sys_jhsj sj 

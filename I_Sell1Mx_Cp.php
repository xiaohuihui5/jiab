...
function SelOk()
{
	...
	window.parent.startRequest(window.Frm.zfl.options[window.Frm.zfl.selectedIndex].text,window.Frm.zfl.value,data_a[window.Frm.zfl.value]);

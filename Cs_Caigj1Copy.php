...
<tr><td align=center height="40"><span class="c-red">*</span>供&nbsp;应&nbsp;商:<input type="hidden" value="<?php echo $UNIT;?>" name="khflid"><input type="hidden" id="oldvalue" name="oldvalue"><input type="text" class="input-text"  onkeyup="AutoFinish()" value="<?php echo $UNITmc;?>" title="请输入关键字"  onclick="this.select();CloseTipDiv();" onkeydown="if(event.keyCode==13) startRequest(this.value,0)" style="width: 210px;"  id="spdm" name="spdm"></td></tr>
...
function sub()
{
	if(window.IFrm.khflid.value=="")
		layer.msg('请选择客户价格分类!',{shade:false});
	else
	{
		window.IFrm.submit();
      }

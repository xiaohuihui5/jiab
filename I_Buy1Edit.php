...
if(isset($_POST['dt1']))
{
	...
	if($_POST['dt2']==$_POST['odt2'])//修改日期的时候单号也要跟着改,否则单号会出现混乱sys_dh表ges=2的不用修改单号
		$query="update sys_jhdh set rq='".$_POST['dt1']."',dhrq='".$_POST['dt2']."',unit=".$_POST['gysid'].",bz=".$IBZ." where id=".$_POST['dhid']."";
	else
		$query="update sys_jhdh set dh='".getdh($_POST['dt2'],$syslx)."',rq='".$_POST['dt1']."',dhrq='".$_POST['dt2']."',unit=".$_POST['gysid'].",bz=".$IBZ." where id=".$_POST['dhid']."";
...
<tr><td align=center height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c-red">*</span>&nbsp;&nbsp;&nbsp;到货日期：<input type="hidden" value="<?php echo $DHRQ;?>"  name="odt2"><input type="text" class="input-text" name="dt2" id="dt2" value="<?php echo $DHRQ;?>" onclick="calendar(this)" style="width:210px;"></td>

...
$tit='基础资料 <span class="c-gray en">&gt;</span> 客户类型';
if($menuright>1)//录入
...
<a href="Cs_KhLx.php"  class="btn radius"><img border=0 src=im/zhuy.png> 客户类型</a> 
...
function sub()
{
	...
	{
		parent.layer.msg('新增客户类型不能为空', {icon:2,time:1500});
		return false;
	}
	else
	{

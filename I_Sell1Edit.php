...
if(isset($_POST['dt1']))
{
	...
	if($_POST['dt2']==$_POST['odt2'])//修改日期的时候单号也要跟着改,否则单号会出现混乱sys_dh表ges=2的不用修改单号
		$query="update sys_jhdh set rq='".$_POST['dt1']."',dhrq='".$_POST['dt2']."',unit=".$_POST['khid'].",bz=".$IBZ." where id=".$_POST['dhid']."";
	else
		$query="update sys_jhdh set dh='".getdh($_POST['dt2'],$syslx)."',rq='".$_POST['dt1']."',dhrq='".$_POST['dt2']."',unit=".$_POST['khid'].",bz=".$IBZ." where id=".$_POST['dhid']."";
...
<table>
<tr><td align=center height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c-red">*</span>&nbsp;&nbsp;&nbsp;订货日期：<input type="hidden" value="<?php echo $RQ;?>"  name="odt1"><input type="text" class="input-text" name="dt1" id="dt1" value="<?php echo $RQ;?>" onclick="calendar(this)" style="width:210px;"></td>
<tr><td align=center height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c-red">*</span>&nbsp;&nbsp;&nbsp;送货日期：<input type="hidden" value="<?php echo $DHRQ;?>"  name="odt2"><input type="text" class="input-text" name="dt2" id="dt2" value="<?php echo $DHRQ;?>" onclick="calendar(this)" style="width:210px;"></td>
<tr><td align=center height="40"><span class="c-red">*</span><a href="javascript:;" onclick="Sel()"><font color=blue>[F9]客户名称：</font></a><input type="hidden" value="<?php echo $UNIT?>" id="khid" name="khid"><input type="hidden" id="oldvalue" name="oldvalue"><input type="text" class="input-text" onkeyup="AutoFinish();" value="<?php echo $UNITmc;?>"  title="请输入关键字"  onclick="this.select();CloseTipDiv();" onkeydown="if(event.keyCode==13) {startRequest(this.value,0);}" style="width: 210px;"  id="spdm" name="spdm"></td></tr>
...
function Sel()
{
	layer_show2("客户选取","I_Select_Kh_S.php","400","460"); //最后一个参数是给一个标识符 
} 
function exit()
{

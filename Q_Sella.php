...
<?php
$tit='查询统计 <span class="c-gray en">&gt;</span> 订单查询 <span class="c-gray en">&gt;</span> 销售明细';
...
$lnk='<span class="l"><a href="Q_Sell.php"  class="btn radius"> 销售单据</a> 
<a href="Q_Sella.php"  class="btn radius"><img border=0 src=im/zhuy.png> 销售明细1</a> 
...
$lnk.='<span class="r"> <a href="xExcel2.php" class="btn radius"><img border=0 src=im/daoc.png>&nbsp;&nbsp; 导&nbsp;&nbsp;出</a> <a href="javascript:openwindow(\'xPrint.php\',850,500)" class="btn radius"><img border=0 src=im/dy.png>&nbsp;&nbsp;打&nbsp;&nbsp;印</a> </span> ';
$cha='';
$lie=',日期,客户名称,单号,标准品名,单位,发货量,客户品名,规格,单位,订货量,送货量,实收量,差量,单价,金额,备注';
$wid=',7%,10%,7%,10%,3%,6%,10%,4%,3%,6%,6%,6%,5%,5%,6%,6%';
$xuh=',2,3,4,5,6,7,,9,,11,12,13,14';

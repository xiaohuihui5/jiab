...
<input type="hidden" name="cpid" id="cpid"><input type="hidden" name="dhid" value="'.$dh_id.'">
...
<a class="btn radius" href="javascript:{openwindow2(\'I_rukMxPrint.php?dhid='.$dhid.'\',700,500);}"><img border="0" src="im/dy.png">打印入库单</a>
</span>';
$lie=",序,编号,商品名称,单位,规格,仓库,入库量,单价,金额,备注,删除,修改";

...
<a href="Q_Selle.php"  class="btn radius"><img border=0 src=im/zhuy.png> 销售明细2</a> 
...
$cha='';
$lie=',日期,客户名称,标准品名,单位,发货量,客户品名,规格,单位,订货量,送货量,实收量,差量,单价,金额,备注';
$wid=',8%,10%,10%,4%,6%,10%,6%,4%,6%,6%,6%,6%,6%,6%,6%';

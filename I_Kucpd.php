...
$tit='库存管理 <span class="c-gray en">&gt;</span> 盘点录入';
...
$lnk='<span class="l"><a href="'.$xiam.'.php"  class="btn radius"><img border=0 src=im/zhuy.png> 盘点管理</a> </span>';
$lnk.='<span class="r">';
$lnk.='<a onclick="Add()" class="btn radius"><img border=0 src=im/add.png> 新增盘点单[F9]</a> </span>'; 
$cha='';
$lie=',序,单号,盘点日期,盘点总量(斤),总金额,制单人,修改,删除';
...
function Add()
{
	layer_show2('新增盘点单','<?php echo $xiam;?>Add.php','500','300'); //最后一个参数是给一个标识符 
} 
</script>

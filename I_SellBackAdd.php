...
if(isset($_POST['dt1']))
{
	...
	$query="insert into sys_jhdh(dh,dhrq,unit,lury,bz,zf,lx,zt) values('".getdh($_POST['dt1'],$syslx)."','".$_POST['dt1']."',".$_POST['khid'].",'".$_SESSION['uname']."',".$IBZ.",1,$syslx,0)";
...
<table>
<tr><td align=center height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c-red">*</span>退货日期：<input type="text" class="input-text" name="dt1" id="dt1" value="<?php echo date('Y-m-d');?>" onclick="calendar(this)" style="width:210px;"></td>

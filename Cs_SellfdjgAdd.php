...
if(isset($_POST['dt1']))
{
	$IBZ=$_POST['beiz']==""?"null":"'".$_POST['beiz']."'";//备注空转null
	$syslx=23;
	$query="insert into sys_selljg(dh,unitid,brq,erq,lx,beiz,lury,dhrq) values('".getdh($_POST['dt1'],$syslx)."',".$_POST['khid'].",'".$_POST['dt1']."','". $_POST['dt2']."',".$syslx.",".$IBZ.",'".$_SESSION['uname']."','".date('Y-m-d')."')";
...
<tr><td align=center height="40"><span class="c-red">*</span><a href="javascript:;" onclick="Sel();"><font color=blue>[F9]客户名称：</font></a><input type="hidden" value="" name="khid"><input type="hidden" id="oldvalue" name="oldvalue"><input type="text" class="input-text" onkeyup="AutoFinish()"   title="请输入关键字"  onclick="this.select();CloseTipDiv();" onkeydown="if(event.keyCode==13) startRequest(this.value,0)" style="width: 210px;"  id="spdm" name="spdm"></td></tr>
...
function Sel()
{
	layer_show2("客户选取","Cs_Select_KhJg_S.php","400","460"); //最后一个参数是给一个标识符 
} 
function exit()
{

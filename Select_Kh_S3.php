...
function SelOk()
{
	window.parent.document.getElementById("khidb").value=window.Frm.zfl.value;
	window.parent.document.getElementById("khmcb").value=window.Frm.zfl.options[window.Frm.zfl.selectedIndex].text;

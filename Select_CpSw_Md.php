...
<td align=center>
	...
	<option value="" style="text-align: center;">无上级选取</option>
	</select>
</td>
</tr>
...
<td align=center >
	...
	<?php 
		$query="select cpfenl.id,cpfenl.fenlmc from sys_cpyfl cpfenl where cpfenl.yn=1 order by cpfenl.bianh,cpfenl.fenlmc";
...
function SelOk()
{
	...
	if(s_id=="") s_name="生产分类";
	parent.Frm.cpylid.value=s_id;
	parent.Frm.cpylmc.value=s_name;
	parent.Frm.cpylmc.title=s_name;

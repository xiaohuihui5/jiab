...
if(isset($_POST['dt1']))
{
	...
	$query="insert into sys_jhdh(dh,rq,dhrq,unit,lury,bz,zf,lx,zt) values('".getdh($_POST['dt2'],$syslx)."','".$_POST['dt1']."','".$_POST['dt2']."',".$_POST['khid'].",'".$_SESSION['uname']."',".$IBZ.",-1,$syslx,0)";
...
<table>
<tr><td align=center height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c-red">*</span>订货日期：<input type="text" class="input-text" name="dt1" id="dt1" value="<?php echo date('Y-m-d');?>" onclick="calendar(this)" style="width:210px;"></td>
<tr><td align=center height="40">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="c-red">*</span>送货日期：<input type="text" class="input-text" name="dt2" id="dt2" value="<?php echo date('Y-m-d',strtotime("+1 day"));?>" onclick="calendar(this)" style="width:210px;"></td>
<tr><td align=center height="40"><span class="c-red">*</span><a href="javascript:;" onclick="Sel()"><font color=blue>[F9]客户名称：</font></a><input type="hidden" value="" id="khid" name="khid"><input type="hidden" id="oldvalue" name="oldvalue"><input type="text" class="input-text" onkeyup="AutoFinish();"   title="请输入关键字"  onclick="this.select();CloseTipDiv();" onkeydown="if(event.keyCode==13) {startRequest(this.value,0);}" style="width: 210px;"  id="spdm" name="spdm"></td></tr>

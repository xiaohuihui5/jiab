...
<?php 
$row=0;
$query = "select sj.id,cp.bh,cp.mc,cp.gg,cast(dh.zf*sj.dinghl as varchar),sj.fudw,cast(dh.zf*sj.songhl as varchar),cast(dh.zf*sj.shisl as varchar),cp.dw,sj.dj,dh.zf*sj.shisje,sj.bz,dh.zt,sj.paix,cp.huansz,sj.mc from sys_jhsj sj,sys_cp cp,sys_jhdh dh where dh.id=sj.dhid and sj.mc=cp.id and sj.dhid=".$_REQUEST['dhid']." order by sj.paix";
...
?>
	<tr onclick="k(this)" onMouseOver="v(this)" onMouseOut="o(this)">
		...
		<td width="22%"><?php echo $line[11];?></td>
	</tr>
<?php
$hjdinghl+=$line[4];
$hjsonghl+=$line[6];

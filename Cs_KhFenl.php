...
<a href="Cs_KhFenl.php"  class="btn radius"><img border=0 src=im/zhuy.png>客户分类</a> 
...
function sub()
{
	...
	{
		parent.layer.msg('新增客户分类不能为空', {icon:2,time:1500});
		return false;
	}
	else
	{

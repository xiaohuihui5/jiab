...
$tis.="&nbsp;&nbsp;退货日期:<font color=black>".$line[1]."</font>";
...
<td algin=center><div class="text-c">退货数</div></td>
<td algin=center><div class="text-c">退货量</div></td>
...
<td algin=center><div class="text-c"><input type="text" class="input-text" style="width:80px" id="dinghs" name="dinghs" onkeypress="check(this,2)" onkeydown="if(event.keyCode==13){window.IFrm.dj.select();}else if(event.keyCode==39){window.IFrm.dj.select();}"></div></td>
...
$lie=",序,编号,商品名称,规格,退货数,退货量,单位,单价,金额,备注,删";
$wid=",5%,9%,18%,9%,10%,9%,5%,9%,9%,12%,5%";
}
else
{
$lie=",序,编号,商品名称,规格,退货数,退货量,单位,单价,金额,备注";
$wid=",5%,9%,18%,9%,10%,9%,5%,9%,10%,16%";
}
$xuh='';
$yul='';
...
clip1.setText('<?php echo $_REQUEST['dhid'];?>;p02.fr3;0;1;1;=)(=');
clip1.glue('c1');
</script>
<script language ="javascript">
function sub()

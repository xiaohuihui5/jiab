...
<tr>
<td width=35%>&nbsp;&nbsp;&nbsp;客户名称:<?php echo $gys;?></td>
<td width=30%>&nbsp;&nbsp;&nbsp;</td>
<td width=35%>单号:<?php echo $dh;?></td>
</tr>
<tr>
<td width=35%>&nbsp;&nbsp;&nbsp;送货日期:<?php echo $rq;?></td>
...
<Td  align=center><b>副单位</b></Td>
<Td  align=center><b>配送量</b></Td>
<Td  align=center><b>实收量</b></Td>
<Td  align=center><b>单位</b></Td>
<Td  align=center><b>单价</b></Td>
<Td  align=center><b>近价</b></Td>
<Td  align=center><b>金额</b></Td>
<Td  align=center><b>备注</b></Td>
</tr>
<?php 
$row=0;
$query = "select cp.id,cp.bh,cp.mc,cp.gg,sj.dinghl,sj.fudw,sj.songhl,sj.shisl,cp.dw,sj.dj,sj.shisje,sj.bz,dh.zt,sj.paix,cp.gg2,sj.chukl from sys_jhsj sj,sys_cp cp,sys_jhdh dh where dh.id=sj.dhid and sj.mc=cp.id and sj.dhid=".$dhid." order by sj.paix";
$result=sqlsrv_query($conn,$query);

...
<td align=center style="width:300px; height:360;">
		<select style="height: 32px;width:100%;" id="typea" name="typea" onchange="window.Frm.submit()">
	...
	<select style="height: 300px;width:100%" onkeydown="if(event.keyCode==13) SelOk();" id="zfl" name="zfl" size="17"  OnDblClick="SelOk()">
		...
		$query="select top 20 id,usercode+shortname from sys_unit where mode=1 and typeb=1 and yn=1 ".$TJ." order by usercode";

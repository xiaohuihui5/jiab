...
//取得生产加工数据信息
$query="select CONVERT(varchar(10),jg.jiagrq,120),jg.unit,jg.fengs,jg.fengz,jg.daietg,jg.bany,jg.suiy,jg.fgbz,jg.fgzt,jg.fgbianzs,jg.fgbianzz,jg.zhuangt from sys_jiagsc jg where jg.id=".$_REQUEST['id'];
...
<table width="95%">
<tr>
	<td width="35%" align=right height="40">加工日期：<input type="hidden" value="<?php echo $zt;?>" name="fgzt"></td>
...
<tr>
	...
	<td><input class="input-text" name="sl1" id="sl1" value="<?php echo $sl1==''?$fengs:$sl1;?>" onkeydown="if(event.keyCode==13 || event.keyCode==40)window.Frm.zl1.focus();" style="width:210px;" onfocus="this.select();"></td>
</tr>
<tr>

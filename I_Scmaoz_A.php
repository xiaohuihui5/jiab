...
$tit='生产管理 <span class="c-gray en">&gt;</span> 生猪出库';
...
$lnk='<span class="l"><a href="I_Scmaoz.php"  class="btn radius"> 生猪入库</a> <a href="'.$xiam.'.php"  class="btn radius"><img border=0 src=im/zhuy.png> 生猪出库</a> </span>';
$lnk.='<span class="r">';
if($menuright>2)//审核
...
$lnk.='<a onclick="Add()" class="btn radius"><img border=0 src=im/add.png> 新增出库单[F9]</a> </span>'; 
$cha='';
$lie=',序,单号,出库日期,头数,出库总量(斤),总金额,制单人,状态,修改,删除';
...
function Add()
{
	layer_show2('新增出库单','<?php echo $xiam;?>Add.php','500','300'); //最后一个参数是给一个标识符 
} 
</script>

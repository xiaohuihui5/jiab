...
<tr><td align=center height="40"><span class="c-red">*</span><a href="javascript:;" onclick="Sel();"><font color=blue>[F9]客户分类：</font></a><input type="hidden" value="" name="khflid"><input type="hidden" id="oldvalue" name="oldvalue"><input type="text" class="input-text" onkeyup="AutoFinish()"   title="请输入关键字"  onclick="this.select();CloseTipDiv();" onkeydown="if(event.keyCode==13) startRequest(this.value,0)" style="width: 210px;"  id="spdm" name="spdm"></td></tr>
...
function Sel()
{
	layer_show2("客户分类选取","Cs_Select_KhflJg_S.php","400","460"); //最后一个参数是给一个标识符 
} 
function exit()
{

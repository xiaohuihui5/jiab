...
$lnk='<span class="l"><a href="Cs_Gys.php"  class="btn radius"> 供应商资料</a> 
<a href="Cs_KhLx.php"  class="btn radius"><img border=0 src=im/zhuy.png> 供应商分类</a> 
</span>';
...
function sub()
{
	...
	{
		parent.layer.msg('新增供应商分类不能为空', {icon:2,time:1500});
		return false;
	}
	else
	{

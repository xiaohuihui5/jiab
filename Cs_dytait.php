...
$lnk='<span class="l"><a href="Cs_Cp.php"  class="btn radius"><img border=0 src=im/zhuy.png> 抬头设置</a></span> <span class="r"><a href="xExcel_NoCountdis.php"  title="导出数据到Excel表" class="btn radius"><img border=0 src=im/daoc.png>&nbsp;&nbsp; 导&nbsp;&nbsp;出</a> <a href="JavaScript:openwindow2(\'xPrint_NoCountdis.php\',850,500)" title="打印当页数据" class="btn radius"><img border=0 src=im/dy.png>&nbsp;&nbsp;打&nbsp;&nbsp;印</a> </span> ';
$cha='';
$lie=",序,编号,打印抬头名称,禁用,修改";
$wid=",10%,10%,60%,10%,10%";
$tis="!";
$xuh='';
$yul='';
...
function sub()
{
	...
	{
		parent.layer.msg('新增打印抬头名称不能为空', {icon:2,time:1500});
		return false;
	}
	else
	{

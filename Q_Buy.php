...
<?php
$tit='查询统计 <span class="c-gray en">&gt;</span> 采购查询 <span class="c-gray en">&gt;</span> 采购单据';
...
$lnk='<span class="l"><a href="Q_Sell.php"  class="btn radius"><img border=0 src=im/zhuy.png> 采购单据</a> 
...
$cha='';
$lie=',单号,编号,供应商,备注,日期,订货量,到货量,实收量,差量,实收金额,状态';

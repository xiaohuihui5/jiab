...
<?php
$tit='查询统计 <span class="c-gray en">&gt;</span> 采购查询 <span class="c-gray en">&gt;</span> 采购明细';
...
<a href="Q_Buya.php"  class="btn radius"><img border=0 src=im/zhuy.png> 采购明细</a> 
...
$lnk.='<span class="r"> <a href="xExcel3.php" class="btn radius"><img border=0 src=im/daoc.png>&nbsp;&nbsp; 导&nbsp;&nbsp;出</a> <a href="javascript:openwindow(\'xPrint.php\',850,500)" class="btn radius"><img border=0 src=im/dy.png>&nbsp;&nbsp;打&nbsp;&nbsp;印</a> </span> ';
$cha='';
$lie=',日期,供应商,单号,产品编号名称,单位,订货量,到货量,实收量,差量,单价,金额,备注';
$wid=',8%,12%,8%,20%,4%,6%,6%,6%,6%,6%,6%,12%';

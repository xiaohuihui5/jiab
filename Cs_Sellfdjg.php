...
$lnk='<span class="l"><a href="Cs_Sellfljg.php"  class="btn radius"> 按分类设价</a> <a href="Cs_Sellfdjg.php"  class="btn radius"><img border=0 src=im/zhuy.png> 按客户设价</a> <a href="Cs_Sellfdtj.php"  class="btn radius"> 按客户特价</a></span>';
$lnk.='<span class="r">';
if($menuright>1)//录入

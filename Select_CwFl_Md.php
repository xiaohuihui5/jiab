...
<td align=center>
	...
	<?php 
		$query="select cpfenl.id,cpfenl.fenlmc from sys_cwfenl cpfenl where cpfenl.yn=1 order by cpfenl.bianh,cpfenl.fenlmc";
...
function SelOk()
{
	...
	if(s_id=="") s_name="财务分类";
	parent.Frm.cwflid.value=s_id;
	parent.Frm.cwflmc.value=s_name;
	parent.Frm.cwflmc.title=s_name;

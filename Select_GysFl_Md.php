...
<td align=center height="10%">
	<select style="width: 275px;font-family: 微软雅黑; font-size: 12px; line-height: 15px;border: 1px #000000 solid" id="cpfl" name="cpfl" onchange="ListLeft()">
...
<tr>
<td align=center  height="10%">
	<input id="cxtj"  tabindex="1" name="cxtj"  onkeydown="if(event.keyCode==13) ListLeft()" style="height:30px;width: 210px;font-family: 微软雅黑; font-size: 12px; line-height: 15px;border: 1px #000000 solid">
...
<td align=center width="100%" height="80%">
	...
	<?php 
		$query="select cpfenl.id,cpfenl.fenlmc from sys_gysfenl cpfenl where cpfenl.yn=1 order by cpfenl.bianh,cpfenl.fenlmc";
...
function SelOk()
{
	...
	if(s_id=="") s_name="供应商分类";
	parent.Frm.gysflid.value=s_id;
	parent.Frm.gysflmc.value=s_name;
	parent.Frm.gysflmc.title=s_name;
